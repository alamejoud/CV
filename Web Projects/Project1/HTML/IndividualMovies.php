...
$movies = $db->Movies;
$users = $db->Users;
$m = $movies->findOne(['id' => (int) $_GET['mid']]);
    ...
    <div class="grid">
        <div class="one">
            <iframe width="100%" height="100%"
                src="https://www.youtube.com/embed/<?php echo $m['youtube_id'] ?>?autoplay=1&mute=1"
        ...
        <div class="two">
            <div class="upper_section">
                <img width="200px" id="movie_banner" src="../Movies Banner/<?php echo $m['img_banner'] ?>" />

                <div>
                    <h4 id="movie_title"><?php echo $m['name'] ?></h4>
                    <hr />
                    <div id="movie_details">
                        <p>
                            <?php echo "Rating: " . $m['rating'] ?>
                        </p>
                        <p>
                            <?php echo "Genre: " . $m['genre'] ?>
                        </p>
                    </div>
                </div>
...
<script src="../JavaScript/IndividualMovie.js"></script>
